...
public class PortfolioView extends javax.swing.JFrame {
    ...
    public PortfolioView(Portfolio p) {
        initComponents();
        portfolio = p;
        cash_textfield.setText(""+p.getCredit());
        updateTable();
	...
	private void setOnhandTable() {
		...
		for(Option o : olist){
			...
			options[i][0] =  o.getSymbol();
			options[i][1] =  ""+o.getType();
			options[i][2] =  ""+o.getUnderlying().getPrice();
			options[i][3] =  ""+o.getVolume();
			options[i][4] =  ""+o.getStrike();
			options[i][5] =  ""+cur_price;
			options[i][6] =  ""+o.getMaturity();
			float net =0;
			...
			if(net > 0)options[i][7] ="+"+net;
			else options[i][7] =""+net;
			total+=net;
			i++;
		}
		options[i][6] = "Total";
    ...
    private void initComponents() {
        ...
        cash_textfield = new javax.swing.JTextField();
        ...
        cash_textfield.setFont(new java.awt.Font("Consolas", 1, 18)); // NOI18N
        cash_textfield.setText("jTextField1");
        cash_textfield.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cash_textfieldActionPerformed(evt);
            }
        });
        cash_textfield.setBounds(509, 30, 130, 28);
        LayeredPane.add(cash_textfield, javax.swing.JLayeredPane.DEFAULT_LAYER);

        cash_lab.setFont(new java.awt.Font("Consolas", 1, 18)); // NOI18N
        cash_lab.setText("Cash");
        cash_lab.setBounds(450, 30, 50, 30);
    ...
    private void cash_textfieldActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }  
    /**
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            	if(TestingMode = true){
            		...
            		p.purchase(new Option((float) 1.50, 20, "ABC", new Stock((float) 3.55, 20, "ABC"), "11/12/2012",(float) 3.40, Option.optiontype.call));
            		p.purchase(new Option((float) 1.50, 20, "ABC", new Stock((float) 3.55, 10, "ABC"), "11/12/2012",(float) 5.40, Option.optiontype.call));
    ...
    private String option_title[] = {"Symbol","Type","Bought at","Volume", "Strike price", "Current price", "Maturity", "Proft/Loss"};
    ...
    private javax.swing.JTextField cash_textfield;
